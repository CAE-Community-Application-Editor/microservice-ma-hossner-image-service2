...
public class Images extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "ma-hossner-image-service2", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "Philipp Hossner", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/CAE-Community-Application-Editor/microservice-ma-hossner-image-service2/blob/master/LICENSE.txt") ) )
  @Path("/")
